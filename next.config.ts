        ...
        headers: [
          {
            ...
            value: [
              ...
              "font-src 'self' data:",
              "connect-src 'self' https://*.s3.ap-northeast-2.amazonaws.com https://*.s3.amazonaws.com https://*.tosspayments.com",
              "frame-src 'self' https://t1.daumcdn.net https://postcode.map.daum.net https://*.daumcdn.net https://*.tosspayments.com https://*.toss.im",
